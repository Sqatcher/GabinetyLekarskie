<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Uaktualnij informacje o swoim profilu oraz email.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="text" class="mt-1 block w-full" :value="old('email', $user->email)" autocomplete="email" />

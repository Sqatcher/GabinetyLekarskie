...
<?php endif; ?>
            ...
            <div style="text-align: justify">
                ...
                <br>
                <div>
                    <a href="https://www.facebook.com"><img class="small-icon" src="<?php echo e(asset('img/facebook.png')); ?>" alt="facebook icon"></a>
                    <a href="https://www.twitter.com"><img class="small-icon" src="<?php echo e(asset('img/twitter.png')); ?>" alt="twitter icon"></a>
                    <a href="https://www.instagram.com"><img class="small-icon" src="<?php echo e(asset('img/instagram.png')); ?>" alt="instagram icon"></a>
                    <a href="https://www.github.com"><img class="small-icon" src="<?php echo e(asset('img/github.png')); ?>" alt="github icon"></a>
                </div>
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(!$user->premium): ?>
                    <div id="ads_1"><img class="ads_img" src="<?php echo e(asset('img/ads/A'.mt_rand(1, 10).'.png')); ?>" alt="Ads icon"></div>
                    <div id="ads_2"><img class="ads_img" src="<?php echo e(asset('img/ads/A'.mt_rand(1, 10).'.png')); ?>" alt="Ads icon"></div>
                <?php endif; ?>
            <?php else: ?>
                <div class="ads_1"><img class="ads_img" src="<?php echo e(asset('img/ads/A'.mt_rand(1, 10).'.png')); ?>" alt="Ads icon"></div>
                <div class="ads_2"><img class="ads_img" src="<?php echo e(asset('img/ads/A'.mt_rand(1, 10).'.png')); ?>" alt="Ads icon"></div>
                <div class="ads_3"><img class="ads_img" src="<?php echo e(asset('img/ads/A'.mt_rand(1, 10).'.png')); ?>" alt="Ads icon"></div>
            <?php endif; ?>
        </div>
    </body>
</html>
<?php /**PATH /home/student/PHP/php_2022_bukmacher/09_laravel_tdd/project/resources/views/welcome.blade.php ENDPATH**/ ?>
...
<div class="relative justify-center" style="justify-content: center; width:80%; margin: 200px auto; display:grid; grid-template-columns: 20% 80%">
    <div class = 'links'>
        <a href="<?php echo e(url("/account/add_balance")); ?>">Doładuj konto</a>
    <?php if(!isset($premium_expire)): ?>
        <a href="<?php echo e(url("/account/premium")); ?>">Kup konto premium</a>
    <?php endif; ?>
        <a href="<?php echo e(url("/account/history")); ?>">Historia kuponów</a>
        <a href="<?php echo e(url("/account/delete")); ?>">Usuń konto</a>
    </div>
...
<?php endif; ?>
        ...
        <br>
            ...
            $i = 0;
            ?>
        <?php $__currentLoopData = $formsy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="static"><p><?php echo e($el); ?></p></div>
            <div class="person"><p><?php echo e($person[$i]); ?></p></div>
            <?php $i += 1; ?>
...
<?php /**PATH /home/student/PHP/php_2022_bukmacher/09_laravel_tdd/project/resources/views/account.blade.php ENDPATH**/ ?>